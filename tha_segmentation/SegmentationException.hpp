...
#include <exception>
#include <string>
#include "tha_segmentation_export.h"

namespace THA
{
	namespace SEGMENTATION
	{
		class THA_SEGMENTATION_EXPORT SegmentationException : public std::exception
		{
			std::string msg_;
		public:
		...
		enum THA_SEGMENTATION_EXPORT SegmentationExceptionCode
		{
