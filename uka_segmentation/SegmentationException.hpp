...
#include <exception>
#include <string>
#include "uka_segmentation_export.h"

namespace UKA
{
	namespace SEGMENTATION
	{
		class UKA_SEGMENTATION_EXPORT SegmentationException : public std::exception
		{
			std::string msg_;
		public:
		...
		enum UKA_SEGMENTATION_EXPORT SegmentationExceptionCode
		{
