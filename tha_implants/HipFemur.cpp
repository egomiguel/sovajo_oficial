...
void HipFemur::init(const Point& headCenter, const Point& neckCenter, const Point& canalDistalCenter, const Point& canalProximalCenter, const Point& lesserTrochanter,
