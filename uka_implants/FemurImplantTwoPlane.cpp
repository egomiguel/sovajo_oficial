...
FemurImplantTwoPlane::FemurImplantTwoPlane()
{
}

void FemurImplantTwoPlane::init(const Plane& pPosterior, const Plane& pObliquePosterior, const Point& pRodBasePoint, 
								...
								const vtkSmartPointer<vtkPolyData> implantModel, const FemurImplantInfo& pImplantInfo)
{
	...
	this->mObliquePosterior = pObliquePosterior;
...
Plane FemurImplantTwoPlane::getDistalPlane() const
{
	return mDistal;
}

Plane FemurImplantTwoPlane::getObliquePosteriorPlane() const
{
	return mObliquePosterior;
}

Plane FemurImplantTwoPlane::getMidPlane() const
{
...
double FemurImplantTwoPlane::getWidthSize() const
{
	auto const count1 = static_cast<float>(mSideBorder1.size());
	auto const count2 = static_cast<float>(mSideBorder2.size());
...
Point FemurImplantTwoPlane::getRodTopPoint() const
{
	return mRodTopPoint;
}

Point FemurImplantTwoPlane::getRodBasePoint() const
{
...
Point FemurImplantTwoPlane::getRodTopPointProjectedOnBaseExterior() const
{
	return mRodTopPointProjectedOnBase - mImplantInfo.femurDistalThickness * mDistal.getNormalVector();
}

std::vector<Point> FemurImplantTwoPlane::getSortPointsSide1() const
{
	return mSideBorder1;
}

std::vector<Point> FemurImplantTwoPlane::getSortPointsSide2() const
{
	return mSideBorder2;
}

std::vector<Point> FemurImplantTwoPlane::getAllSidePointsInOrder(double pOffset) const
{
...
std::vector<Point> FemurImplantTwoPlane::getAllSidePointsInOrder(cv::Mat& pRotation, cv::Mat& pTranslation, double pOffset) const
{
	std::vector<Point> result;
...
Plane FemurImplantTwoPlane::getBestPlaneToCurvePoints() const
{
	std::vector<Point> points = getAllSidePointsInOrder();
	bool error;
	Plane tPlane = Plane::getBestPlane(points, error);
	tPlane.reverseByPoint(mRodTopPoint);
	return tPlane;
}

Point FemurImplantTwoPlane::getDirectVectorFemurAxis() const
{
	return mVectorForceLine;
}

Point FemurImplantTwoPlane::getDirectVectorTEA() const
{
	return mVectorTEA;
}

Point FemurImplantTwoPlane::getDirectVectorAP() const
{
	return mVectorAP;
}
