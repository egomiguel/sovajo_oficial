...
public:
  ...
  bool Convert(vtkPolyData* planarContoursPolyData, vtkPolyData* closedSurfacePolyData);

  /// Get the cost of the conversion.
  unsigned int GetConversionCost(vtkDataObject* sourceRepresentation = nullptr, vtkDataObject* targetRepresentation = nullptr);
