...
#include <exception>
#include <string>
#include "pka_segmentation_export.h"

namespace PKA
{
	namespace SEGMENTATION
	{
		class PKA_SEGMENTATION_EXPORT SegmentationException : public std::exception
		{
			std::string msg_;
		public:
		...
		enum PKA_SEGMENTATION_EXPORT SegmentationExceptionCode
		{
