...
public:
    ...
    std::vector<PointTypeITK> GetHullPoints(const itk::Rigid3DTransform<>::Pointer pTransformIn, itk::Rigid3DTransform<>::Pointer pTransformOut, double distance = 1., double distancePcl = 1., double closeAngle = 1.0, int amount = 200) const;
