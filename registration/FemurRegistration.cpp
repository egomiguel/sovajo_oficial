    ...
    :Registration(img)
{
    ...
    medialEpicondyleCT = pMedialEpicondyleCT;
}
...
bool FemurRegistration::MakeRegistration(const std::vector<itk::Point<double, 3>>& pBonePoints, const PointTypeITK& pHipCamera, const PointTypeITK& pKneeCenterCamera, const PointTypeITK& pMedialEpicondyleCamera, bool useRandomAlignment)
{
    ...
    target.push_back(medialEpicondyleCT);
